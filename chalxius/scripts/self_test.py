...
def main() -> int:
    ...
    identity_requirements = {
        "SKILL.md": (
            ...
            "Pulse remains a separate legacy collaboration mechanism",
        ...
        "INHERITANCE.lock.json": (
            '"skill_name": "chalxius"',
            '"version": "0.6.7"',
            '"release_codename": "Plain-Language Attack Recommendations"',
            ...
            '"contract_revision": "chalxius-v5-two-subround-research-1"',
        ...
        "references/portable_deployment.md": (
            "The 0.6.7 `Plain-Language Attack Recommendations` release artifact",
